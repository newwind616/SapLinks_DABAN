...
namespace SAPLinks.Bussiness.AfterSaleBussiness.WC
{
    ...
    /// 应交税费-增-进项(调整)
    /// </summary>
    public class InputVATDifferenceAdjustmentAC : AInputVATDifferenceAdjustmentAC
    {
        protected override List<AccVouch> DoLoad()
        {
            ...
            accVouch.NEWKO = "2171010700";//客户 / 供应商 / 会计科目代码（NEWKO）//付款通知书选择支付对象的供应商代码
            accVouch.NEWBS = "50";//记账码（NEWBS）
