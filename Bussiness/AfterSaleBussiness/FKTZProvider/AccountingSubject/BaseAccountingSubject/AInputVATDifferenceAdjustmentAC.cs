...
{
    public abstract class AInputVATDifferenceAdjustmentAC : IAccountingSubject
    {
        ...
        protected virtual decimal GetWRBTR()
        {
            ...
            return result;
            //return decimal.Round(context.Fktzs_C_HEntitys.SjjeTotal / (1 + context.InvoiceEntitys.TaxTate) - context.InvoiceEntitys.TaxTotal);
        }
