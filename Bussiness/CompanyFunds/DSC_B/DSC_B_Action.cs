using SAPLinks.Bussiness.CompanyFunds.DSC_B;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DSC_B
{
    public class DSC_B_Action : CompanyObject, ICompanyAction
    {
        ...
        public DSC_B_Action()
        {
            ...
            _filePath = "DSC_B_Path_C".ToAppSetting();
            _fileName = "DSC_B_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DSC_B_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
