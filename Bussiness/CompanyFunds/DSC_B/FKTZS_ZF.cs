...
ORDER BY CC.ID ASC,AA.APPLY_NO ASC,BB.ID ASC";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                headerText = string.Format("{0}支付{1}：{2} {3}", apply_DisplayName.SubstringExt(4), pay_obj_name.SubstringExt(10), _abstract.SubstringExt(4), findisplayname.SubstringExt(3));
