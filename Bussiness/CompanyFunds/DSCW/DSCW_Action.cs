using SAPLinks.Bussiness.CompanyFunds.DSCW;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DSCW
{
    public class DSCW_Action : CompanyObject, ICompanyAction
    {
        public DSCW_Action()
        {
            ...
            _filePath = "DSCW_Path_C".ToAppSetting();
            _fileName = "DSCW_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DSCW_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
