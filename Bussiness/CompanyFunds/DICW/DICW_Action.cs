using SAPLinks.Bussiness.CompanyFunds.DICW;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DICW
{
    public class DICW_Action : CompanyObject, ICompanyAction
    {
        public DICW_Action()
        {
            ...
            _filePath = "DICW_Path_C".ToAppSetting();
            _fileName = "DICW_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DICW_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
