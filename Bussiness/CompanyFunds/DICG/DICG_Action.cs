using SAPLinks.Bussiness.CompanyFunds.DICG;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DICG
{
    public class DICG_Action : CompanyObject, ICompanyAction
    {
        public DICG_Action()
        {
            ...
            _filePath = "DICG_Path_C".ToAppSetting();
            _fileName = "DICG_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DICG_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
