...
ORDER BY CC.ID ASC,AA.APPLY_NO ASC,BB.ID ASC";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                headerText = string.Format("{0}支付{1} {2}", apply_DisplayName, _abstractABB, findisplayname);
                bodyText = string.Format("{0}支付{1} {2}", apply_DisplayName, _abstract, findisplayname);
