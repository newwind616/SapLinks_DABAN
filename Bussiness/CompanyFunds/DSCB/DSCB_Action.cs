using SAPLinks.Bussiness.CompanyFunds.DSCB;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DSCB
{
    public class DSCB_Action : CompanyObject, ICompanyAction
    {
        public DSCB_Action()
        {
            ...
            _filePath = "DSCB_Path_C".ToAppSetting();
            _fileName = "DSCB_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DSCB_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
