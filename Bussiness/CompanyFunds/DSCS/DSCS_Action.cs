using SAPLinks.Bussiness.CompanyFunds.DSCS;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DSCS
{
    public class DSCS_Action : CompanyObject, ICompanyAction
    {
        public DSCS_Action()
        {
            ...
            _filePath = "DSCS_Path_C".ToAppSetting();
            _fileName = "DSCS_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DSCS_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
