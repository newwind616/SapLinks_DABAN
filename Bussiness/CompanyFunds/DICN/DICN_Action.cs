using SAPLinks.Bussiness.CompanyFunds.DICN;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DICN
{
    public class DICN_Action : CompanyObject, ICompanyAction
    {
        public DICN_Action()
        {
            ...
            _filePath = "DICN_Path_C".ToAppSetting();
            _fileName = "DICN_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DICN_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
