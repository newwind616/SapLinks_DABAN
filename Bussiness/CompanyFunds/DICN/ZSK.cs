...
FROM DABAN_BPM_DICN.DBO.ZSK_C_H AA
LEFT JOIN BPMDB.DBO.SAP_COMPANYFUNDS_LINKS_QUEUE CC ON AA.APPLY_NO=CC.APPLY_NO
WHERE CC.COMPANY='DICN' AND CC.ISLINK=0 AND CC.ISLINK=0
...
";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                //string newbs = ConvertVenderToNEWBS(pay_obj_id,dicn_Action.company);
                //string newum = ConvertVenderToNEWUM(pay_obj_id, dicn_Action.company);
