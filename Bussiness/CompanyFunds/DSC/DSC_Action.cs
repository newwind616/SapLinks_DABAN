using SAPLinks.Bussiness.CompanyFunds.DSC;
using System;
...
namespace SAPLinks.Bussiness.CompanyFunds.DSC
{
    public class DSC_Action : CompanyObject, ICompanyAction
    {
        public DSC_Action()
        {
            ...
            _filePath = "DSC_Path_C".ToAppSetting();
            _fileName = "DSC_Name_C".ToAppSetting() + DateTime.Now.ToString("yyyyMMddHHmmss");
            _fileExt = "DSC_Ext_C".ToAppSetting();
            BasicDataLoad();
        }
        public void Start()
        {
